...
import { Avatar, Button, Card, Title, Divider, Paragraph } from 'react-native-paper';
export default class Journal extends Component {
  ...
  render() {
    return <Card
        style={{flex: 1, flexDirection: 'row', alignItems: 'center', alignContent: 'center', alignSelf: 'center'}}>
